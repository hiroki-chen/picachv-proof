...
Example relation := (RelationWrapped ((IntegerType, "foo"%string) :: (IntegerType, "bar"%string) :: nil) 
(((1, 2), (3, 4, tt)) :: nil)).
(* expr' =  (λ x. _0) 1 *)
...
Example result'_is_rel : result' = EResultRelation (RelationWrapped ((IntegerType, "foo"%string) :: nil) ((1, 2, tt) :: nil)).
